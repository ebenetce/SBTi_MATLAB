classdef ScoreAggregations
    ...
    properties
        short (:,1) SBTi.ScoreAggregationScopes = SBTi.ScoreAggregationScopes.empty()
        mid   (:,1) SBTi.ScoreAggregationScopes = SBTi.ScoreAggregationScopes.empty()
        long  (:,1) SBTi.ScoreAggregationScopes = SBTi.ScoreAggregationScopes.empty()
    end
